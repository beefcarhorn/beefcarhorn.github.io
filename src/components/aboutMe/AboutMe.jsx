    ...
    <div className='AboutMe' id='AboutMe'>
      ...
      <div ref={aboutRef} className={`about__header__underline ${aboutVisible ? 'about__anim' : ''}`}></div>
        <div className='main__width'>
          <div ref={freeRef} className={`freetime__container ${freeVisible ? 'free__anim' : ''}`}>
          ...
          <div ref={travelRef} className={`travel__container ${travelVisible ? 'travel__anim' : ''}`}>
          ...
          <div ref={artRef} className={`art__container ${artVisible ? 'art__anim' : ''}`}>
